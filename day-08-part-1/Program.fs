...
let antennaGroups = antennas |> List.groupBy _.Frequency
...
let getAntinodes point1 point2 =
    let antinode1 = { X = 2 * point1.X - point2.X; Y = 2 * point1.Y - point2.Y }
    let antinode2 = { X = 2 * point2.X - point1.X; Y = 2 * point2.Y - point1.Y }

    [antinode1; antinode2] |> List.filter isPointInBounds
