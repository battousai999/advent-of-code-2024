...
// the Red-Nosed reactor. You turn to check if The Historians are waiting for you, but they seem to have already divided into groups
...
let safeReports =
    reports
        |> Seq.filter (fun list -> (isMonotonic list) && (list |> isWithinRange 1 3))
